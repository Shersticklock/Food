# Generated by Django 3.2.11 on 2022-01-12 10:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='restapi.Food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='restapi.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
